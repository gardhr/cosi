...
Cosi requires no installation. Just #include "cosi.c" and you're good to go. (Note that if you're compiling multiple modules separately then you will need to #include "cosi.h" instead and also #define cosi_standard_linkage in order to prevent linker errors.)
...
Cosi is still very much in the early stages of development. At this point however the code is pretty stable. So enjoy!  

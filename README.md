...
Based on the [MuJS](https://mujs.com) Javascript (ES5) engine, Cosi provides a direct interface to most of the ISO C standard API. The library has a remarkably small footprint and will compile on just about any platform. 
